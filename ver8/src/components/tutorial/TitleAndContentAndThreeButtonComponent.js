...
/* 스타일 */
const TitleAndContenAndThreeButtonContainer = styled.div`
    display: flex;
...
function TitleAndContenAndThreeButtonComponent({title, content, addInfo, buttonInfo, setPage, prePage}) {
    ...
    return (
        <TitleAndContenAndThreeButtonContainer>
            {/* 뒤로 가기 버튼 */}
            <MovePageButtonBox>
                <IconButton
                    sx={{...MoveButtonStyle}}
...
export default TitleAndContenAndThreeButtonComponent;